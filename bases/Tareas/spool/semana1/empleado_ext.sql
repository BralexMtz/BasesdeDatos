...
--se otorgan permisos para que el usuario brayan0507 de la BD pueda leer
--el contenido del directorio
grant read, write on directory tmp_dir to brayan0507;

prompt Contectando con usuario brayan0507 para crear la tabla externa
connect brayan0507
show user
